...
import DesignDecisionsModal from "./components/DesignDecisionsModal";
...
export default function Home() {
  ...
  // Document upload state (single upload flow)
  ...
  // The "active" document to chat with — either freshly uploaded OR selected from library
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col selection:bg-zinc-800 selection:text-white">
            ...
            {activeDocId ? (
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="text-xs text-zinc-500 hover:text-zinc-300 bg-zinc-900 border border-zinc-800 px-2.5 py-1 rounded-md transition-colors"
                >
                  Unload
                </button>
              </div>
      ...
      <main className="flex-1 flex overflow-hidden">
        ...
        {libOpen && (
          <aside className="w-72 flex-shrink-0 border-r border-zinc-900 bg-zinc-950/60 h-[calc(100vh-65px)] sticky top-[65px] overflow-hidden flex flex-col">
            <DocumentLibrary
              documents={documents}
              loading={libLoading}
              error={libError}
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="mx-auto max-w-5xl px-6 py-10 grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <section className="lg:col-span-5 space-y-6">
              <div className="space-y-1">
                ...
                <p className="text-xs text-zinc-500">
                  Upload a new document or select one from your library to start chatting.
                </p>
              </div>
                    ...
                    <textarea
                      ...
                      placeholder={
                        effectiveStatus === "succeeded"
                          ...
                          : "Upload or select a document from the library to unlock chat"
                      }
